...
function sendRequest(callOptions, callback) {
  ...
  //the following is unnecessary - constructUri handles null query correctly. - pgc
  /***
     * let uri; if (callOptions.query) uri =
     * constructUri(callOptions.serviceNowTablename, callOptions.query); else
     * uri = constructUri(callOptions.serviceNowTablename);
     *************************************************************************/
